        ...
        <div className="mt-24 border-t-4 border-slate-100 pt-16 no-print">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              { 
                line: "Line 19", title: "Retirement Plans", color: "#6366f1", // Indigo
                text: "သင့်ကိုယ်တိုင် သို့မဟုတ် ဝန်ထမ်းများအတွက် ထည့်ဝင်သော 401(k) စရိတ်များကို ဒီမှာဖြည့်ပါ။", tip: "401(k) ထဲ ပိုက်ဆံထည့်ခြင်းက သင့်ရဲ့ အခွန်ဆောင်ရမယ့် ဝင်ငွေကို တိုက်ရိုက်လျှော့ချပေးပါတယ်။" 
              },
