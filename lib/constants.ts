...
export const TAX_CATEGORIES = [
  ...
  { 
    label: "Retirement (401k/SEP IRA)", 
    value: "retirement_plans", 
    type: "expense",
    line: "Schedule C - Line 19",
    info: "Retirement Plans: ဝန်ထမ်းများ သို့မဟုတ် မိမိအတွက် ပေးသွင်းသော အငြိမ်းစား စုဆောင်းငွေများ ဖြစ်ပါသည်။",
    tip: "401(k) ထဲသို့ ပိုက်ဆံထည့်ခြင်းသည် လုပ်ငန်းအသုံးစရိတ်အဖြစ် ပြလို့ရရုံတင်မကဘဲ၊ မိမိ၏ အသားတင်အမြတ် (Taxable Income) ကိုပါ တိုက်ရိုက်လျှော့ချပေးသည့်အတွက် အခွန် အများကြီး သက်သာစေပါသည်။"
  },
];